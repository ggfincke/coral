// tests/agent/turn-context.test.ts
// causal tests for accepted turns, captured bytes, & unified request budgets
...
import { estimateMessageTokens } from '../../src/agent/compaction.js'
import {
