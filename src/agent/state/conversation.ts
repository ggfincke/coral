// src/agent/state/conversation.ts
// conversation state and revision-checked history transitions
...
// identify the accepted user message owned by this state
...
// validate a summary commit after its awaited request
...
// validate a file-replay commit after its awaited I/O
...
// stored-token counts exclude Agent-owned tools and request framing
...
/** Mutable conversation state with revision-checked transitions. */
