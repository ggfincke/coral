...
const CORAL_REEF: Theme = {
  ...
  roles: {
    ...
    diffAddBg: { r: 29, g: 42, b: 32 },
    diffRemoveBg: { r: 47, g: 31, b: 34 },
    gutter: { r: 35, g: 38, b: 44 },
    selection: { r: 31, g: 39, b: 51 },
  },
...
const DEEP_SEA: Theme = {
  ...
  roles: {
    ...
    diffAddBg: { r: 20, g: 38, b: 32 },
    diffRemoveBg: { r: 42, g: 26, b: 30 },
    gutter: { r: 22, g: 28, b: 38 },
    selection: { r: 26, g: 36, b: 56 },
  },
  headings: DEFAULT_HEADINGS,
}
...
const SUNSET_TIDE: Theme = {
  ...
  roles: {
    ...
    diffAddBg: { r: 31, g: 40, b: 32 },
    diffRemoveBg: { r: 51, g: 32, b: 31 },
    gutter: { r: 43, g: 37, b: 35 },
    selection: { r: 38, g: 38, b: 52 },
  },
  headings: DEFAULT_HEADINGS,
}
...
const KELP_FOREST: Theme = {
  ...
  roles: {
    ...
    diffAddBg: { r: 29, g: 42, b: 32 },
    diffRemoveBg: { r: 45, g: 33, b: 28 },
    gutter: { r: 34, g: 38, b: 34 },
    selection: { r: 30, g: 40, b: 44 },
  },
  headings: DEFAULT_HEADINGS,
}
...
const TIDE_POOL: Theme = {
  ...
  roles: {
    ...
    diffAddBg: { r: 37, g: 49, b: 42 },
    diffRemoveBg: { r: 55, g: 37, b: 43 },
    gutter: { r: 40, g: 42, b: 50 },
    selection: { r: 42, g: 45, b: 62 },
  },
  headings: DEFAULT_HEADINGS,
}
...
const ADAPTIVE: Theme = {
  ...
  roles: {
    ...
    diffAddBg: { ansi: 'green' },
    diffRemoveBg: { ansi: 'red' },
    gutter: { ansi: 'black' },
    selection: { ansi: 'blue' },
  },
  headings: DEFAULT_HEADINGS,
