...
export type PermissionPolicy = "always_allow" | "require_approval" | "always_deny";
...
function isValidPolicy(value: unknown): value is PermissionPolicy {
  return value === "always_allow" || value === "require_approval" || value === "always_deny";
}
...
function mergePermissions(base: ToolPermissions, override: ToolPermissions): ToolPermissions {
...
export function getToolPolicy(permissions: ToolPermissions, toolName: string): PermissionPolicy {
